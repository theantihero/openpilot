...
_AWARENESS_PRE_TIME_TILL_TERMINAL = 30.  # a first alert is issued 25s before expiration
_AWARENESS_PROMPT_TIME_TILL_TERMINAL = 12.  # a second alert is issued 15s before start decelerating the car
_DISTRACTED_TIME = 22.
