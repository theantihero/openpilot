...
//      brake rising edge
//      brake > 0mph
const CanMsg HONDA_N_TX_MSGS[] = {{0xE4, 2, 5}, {0x1FA, 2, 8},  {0x30C, 2, 8}, {0x33D, 2, 5}, {0x300, 1, 8}, {0x301, 1, 8}, {0x18DA28F1, 2,	8}, {0x18DA30F1, 2, 8}, {0x18DA53F1, 2, 8}}; //Clarity Dual-CAN Nidec
